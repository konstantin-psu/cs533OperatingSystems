/*
  ...
  Short smi length 5 microseconds
*/

#include <linux/proc_fs.h>
#include <linux/pci.h>

// Controls 18 rate of SMIs. Can be adjusted. 
#define DRIVER_RATE 18
...
int write_proc_file(struct file* file, const char* buffer, unsigned long count, void *data)
{
  ...
  option = simple_strtoul(buffer, endp, 18);
